...
export default function EmployeeNotLoggedInFVGrid(props) {
  ...
  useEffect(() => {
    ...
    const filterName = "NOT_LOGIN";
    const type = "Attendance";
    const userId = "378";
    axios.post(`${ApiPort}/DashboardMenu/DashboardGridViewFV?branchid=${branchIds}&stateid=${stateIds}&FilterName=${filterName}&Type=${type}&userid=${userId}`)
  ...
  const exportToExcel = () => {
    ...
    workbook.xlsx.writeBuffer().then((data) => {
      ...
      a.href = url;
      a.download = 'Employee Attendance details - Employees Not Logged In.xlsx';
      a.click();
