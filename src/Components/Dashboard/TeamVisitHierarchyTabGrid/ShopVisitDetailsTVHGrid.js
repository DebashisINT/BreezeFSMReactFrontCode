...
export default function ShopVisitDetailsTVHGrid(props) {
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    {
        field: 'ShopVisitimage',
        filter: true,
        autoHeight: true,
        floatingFilter: true,
        cellRenderer: (params) => {
          const imageName = params.value;
          const imagePath = params.data.Type === 'Re-Visit'
            ? `http://3.7.30.86:8072/CommonFolder/Shoprevisit/${imageName}`
            : `http://3.7.30.86:8072/CommonFolder/${imageName}`;
            ...
            return (
              <div>
                <img
                  ...
                  height="42"
                  width="42"
                  onClick={() => openOverlay(imagePath)}
                />
                {overlayImageUrl === imagePath && (
