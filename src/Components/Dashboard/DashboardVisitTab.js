...
export default function DashboardVisitTab(props) {

    const ApiPort = props.apiPort;
    console.log("DashboardVisitTab:", ApiPort);
  ...
  return (
    ...
    {showTotalEmployeesGrid && (
                <div className='mt-5'>
                    ...
                    <TotalEmployeesGrid key="TotalEmployeesGrid" apiPort={ApiPort}/>
                </div>
            )}
    ...
    {showEmployeeAtWorkGrid && (
                <div className='mt-5'>
                    ...
                    <EmployeeAtWorkGrid key="employeeAtWorkGrid" apiPort={ApiPort}/>
                </div>
            )}
    ...
    {showEmployeeOnLeaveGrid && (
                <div className='mt-5'>
                    ...
                    <EmployeeOnLeaveGrid key="EmployeeOnLeaveGrid" apiPort={ApiPort}/>
                </div>
            )}
    ...
    {showNotLoggedInGrid && (
                <div className='mt-5'>
                    ...
                    <EmployeeNotLoggedInGrid key="EmployeeNotLoggedInGrid" apiPort={ApiPort}/>
                </div>
            )}
    </>
  )
